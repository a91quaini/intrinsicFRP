...
FGXThreePassCovarianceCpp <- function(returns, control_factors, new_factors, sdf_coefficients, idx_selected) {
    .Call(`_intrinsicFRP_FGXThreePassCovarianceCpp`, returns, control_factors, new_factors, sdf_coefficients, idx_selected)
}
