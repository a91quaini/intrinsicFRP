...
#' @noRd
#'
OptimalAdaptiveFRPCpp <- function(returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type = 'c') {
    .Call(`_intrinsicFRP_OptimalAdaptiveFRPCpp`, returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type)
}
...
#'
StandardErrorsAdaptiveFRPCpp <- function(afrp, returns, factors, variance_returns, mean_returns) {
    .Call(`_intrinsicFRP_StandardErrorsAdaptiveFRPCpp`, afrp, returns, factors, variance_returns, mean_returns)
}
...
#' @noRd
#'
OptimalAdaptiveIFRPIGCVCpp <- function(returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type = 'c', gcv_aic_scaling = TRUE, one_stddev_rule = FALSE) {
    .Call(`_intrinsicFRP_OptimalAdaptiveIFRPIGCVCpp`, returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type, gcv_aic_scaling, one_stddev_rule)
}
