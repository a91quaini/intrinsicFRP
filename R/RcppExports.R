...
#' @noRd
#'
OptimalAdaptiveFRPGCVCpp <- function(returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type = 'c', one_stddev_rule = FALSE, gcv_vr_weighting = FALSE, gcv_scaling_n_assets = FALSE, include_standard_errors = FALSE) {
    .Call(`_intrinsicFRP_OptimalAdaptiveFRPGCVCpp`, returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type, one_stddev_rule, gcv_vr_weighting, gcv_scaling_n_assets, include_standard_errors)
}
...
#' @noRd
#'
OptimalAdaptiveIFRPGCVCpp <- function(returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type = 'c', one_stddev_rule = FALSE, gcv_vr_weighting = FALSE, gcv_scaling_n_assets = FALSE, include_standard_errors = FALSE) {
    .Call(`_intrinsicFRP_OptimalAdaptiveIFRPGCVCpp`, returns, factors, covariance_factors_returns, variance_returns, mean_returns, penalty_parameters, weighting_type, one_stddev_rule, gcv_vr_weighting, gcv_scaling_n_assets, include_standard_errors)
}
