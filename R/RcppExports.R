...
GiglioXiu2021RiskPremiaCpp <- function(returns, factors, which_n_pca = 0L, n_max_pca = 0L) {
    .Call(`_intrinsicFRP_GiglioXiu2021RiskPremiaCpp`, returns, factors, which_n_pca, n_max_pca)
}
