...
// @param covariance_factors_returns
// @param variance_returns
// @param mean_returns
...
// intrinsic risk premia estimator 'a'; otherwise a vector of ones (any other
// character). Default is 'c'.
// @param n_train_observations number of observations in the rolling
// training set. Default is 120.
...
// For internal use
// Computes the relaxed adaptive intrinsic factor risk premia based on a
// pre-computed adaptive intrinsic factor risk premia and moments of factors
// and asset excess returns. That is, it fits a sample intrinsic factor risk
// premia estimator on the active set of the pre-computed adaptive intrinsic
// factor risk premia.
//
// [[Rcpp::export]]
...
//
// @param adaptive_ifrp n_factors-dimensional vector of intrinsic factor risk
