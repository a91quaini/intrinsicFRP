...
//
// @name FRPCpp
// @description Computes Fama-MacBeth factor risk premia based on moments
...
// @description Computes the HAC standard errors of Fama-MacBeth factor risk
...
// E.g., the result of function ComputeKRSFactorRiskPremia.
